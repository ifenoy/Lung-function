...
static void createModuleCodeObjects(void) {
    ...
    codeobj_41d3acc53d2b619348846fac650c494f = MAKE_CODE_OBJECT(module_filename_obj, 27, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[36], mod_consts[36], mod_consts[45], NULL, 2, 0, 0);
    codeobj_05859f8ada25303039319eeb54473d01 = MAKE_CODE_OBJECT(module_filename_obj, 54, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[38], mod_consts[38], mod_consts[46], NULL, 1, 0, 0);
}
...
static PyObject *impl_PIL$GimpPaletteFile$$$function__1___init__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_41d3acc53d2b619348846fac650c494f = MAKE_FUNCTION_FRAME(codeobj_41d3acc53d2b619348846fac650c494f, module_PIL$GimpPaletteFile, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_41d3acc53d2b619348846fac650c494f);
...
static PyObject *impl_PIL$GimpPaletteFile$$$function__2_getpalette(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_05859f8ada25303039319eeb54473d01)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_05859f8ada25303039319eeb54473d01 = MAKE_FUNCTION_FRAME(codeobj_05859f8ada25303039319eeb54473d01, module_PIL$GimpPaletteFile, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_05859f8ada25303039319eeb54473d01);
