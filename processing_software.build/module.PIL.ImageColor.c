...
static PyObject *impl_PIL$ImageColor$$$function__1_getrgb(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_b9ea5ad00e436f0b136e7f83336e506b = MAKE_FUNCTION_FRAME(codeobj_b9ea5ad00e436f0b136e7f83336e506b, module_PIL$ImageColor, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_b9ea5ad00e436f0b136e7f83336e506b);
...
static PyObject *impl_PIL$ImageColor$$$function__2_getcolor(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_09a39fd0ce707c9f5f4aa652fd4f3408)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_09a39fd0ce707c9f5f4aa652fd4f3408 = MAKE_FUNCTION_FRAME(codeobj_09a39fd0ce707c9f5f4aa652fd4f3408, module_PIL$ImageColor, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_09a39fd0ce707c9f5f4aa652fd4f3408);
    ...
    // Tried code:
    {
        ...
        CHECK_OBJECT(par_color);
        tmp_args_element_value_1 = par_color;
        frame_09a39fd0ce707c9f5f4aa652fd4f3408->m_frame.f_lineno = 133;
    ...
    branch_no_1:;
    {
        ...
        frame_09a39fd0ce707c9f5f4aa652fd4f3408->m_frame.f_lineno = 137;
