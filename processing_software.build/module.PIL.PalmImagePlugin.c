...
static PyObject *impl_PIL$PalmImagePlugin$$$function__2__save(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_c61998595a7324c85ca6e3eb013de61d)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_c61998595a7324c85ca6e3eb013de61d = MAKE_FUNCTION_FRAME(codeobj_c61998595a7324c85ca6e3eb013de61d, module_PIL$PalmImagePlugin, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_c61998595a7324c85ca6e3eb013de61d);
