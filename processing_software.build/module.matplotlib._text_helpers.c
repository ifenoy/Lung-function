...
static PyObject *impl_matplotlib$_text_helpers$$$function__1_warn_on_missing_glyph(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_a06c132edd77fb869be56e7413076af5 = MAKE_FUNCTION_FRAME(codeobj_a06c132edd77fb869be56e7413076af5, module_matplotlib$_text_helpers, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_a06c132edd77fb869be56e7413076af5);
    ...
    // Framed code:
    {
        ...
        frame_a06c132edd77fb869be56e7413076af5->m_frame.f_lineno = 19;
        tmp_kw_call_arg_value_2_1 = CALL_FUNCTION_WITH_POSARGS1(tmp_called_value_2, mod_consts[6]);
...
static PyObject *matplotlib$_text_helpers$$$function__2_layout$$$genobj__1_layout_context(struct Nuitka_GeneratorObject *generator, PyObject *yield_return_value) {
    ...
    if (isFrameUnusable(cache_m_frame)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_m_frame = MAKE_FUNCTION_FRAME(codeobj_277749c9287cda33e3de534fcdd2a066, module_matplotlib$_text_helpers, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    }
    {
        ...
        generator->m_frame->m_frame.f_lineno = 65;
        {
            ...
            tmp_assign_source_9 = CALL_FUNCTION_WITH_ARGS1_KWSPLIT(tmp_called_value_3, args, kw_values, mod_consts[59]);
        }
    ...
    }
    {
        ...
        tmp_truediv_expr_left_2 = LOOKUP_ATTRIBUTE(tmp_expression_value_5, mod_consts[61]);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_2a3031a8f14d78beec22357c04c70a7f);
    ...
    // Tried code:
    {
        ...
        if (PyModule_Check(tmp_import_name_from_2)) {
            ...
            tmp_assign_source_7 = IMPORT_NAME_FROM_MODULE(tmp_import_name_from_2, mod_consts[76]);
        }
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_3)) {
            ...
            tmp_assign_source_8 = IMPORT_NAME_FROM_MODULE(tmp_import_name_from_3, mod_consts[58]);
        }
