...
static PyObject *impl_matplotlib$stackplot$$$function__1_stackplot(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_7eec7804ae831727153d66cc6ece8080 = MAKE_FUNCTION_FRAME(codeobj_7eec7804ae831727153d66cc6ece8080, module_matplotlib$stackplot, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_7eec7804ae831727153d66cc6ece8080);
    ...
    }
    {
        ...
        tmp_call_posargs_values_1 = DEEP_COPY_TUPLE_GUIDED(mod_consts[12], "l");
    ...
    }
    {
        ...
        tmp_iadd_expr_right_1 = LOOKUP_SUBSCRIPT(tmp_expression_value_7, tmp_subscript_value_1);
    ...
    }
    {
        ...
        tmp_truediv_expr_right_1 = LOOKUP_SUBSCRIPT(tmp_expression_value_11, tmp_subscript_value_4);
    ...
    }
    {
        ...
        tmp_ass_subscribed_3 = LOOKUP_ATTRIBUTE(tmp_expression_value_18, mod_consts[41]);
    ...
    }
    {
        ...
        CHECK_OBJECT(var_y);
        tmp_len_arg_1 = var_y;
        tmp_sub_expr_left_6 = BUILTIN_LEN(tmp_len_arg_1);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_1f3cb3f444b35064dc1237795311d0b2);
