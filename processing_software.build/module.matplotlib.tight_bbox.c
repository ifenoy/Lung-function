...
static PyObject *impl_matplotlib$tight_bbox$$$function__1_adjust_bbox(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_4daecacc08e3f21c6bb820dd0474ac28);
    ...
    }
    {
        ...
        tmp_truediv_expr_right_1 = LOOKUP_ATTRIBUTE(tmp_expression_value_13, mod_consts[23]);
    ...
    // Tried code:
    {
        ...
        tmp_mult_expr_left_1 = LOOKUP_ATTRIBUTE(tmp_expression_value_19, mod_consts[30]);
        ...
        tmp_iter_arg_3 = MAKE_TUPLE_EMPTY(2);
        {
            ...
            tmp_mult_expr_left_2 = LOOKUP_ATTRIBUTE(tmp_expression_value_21, mod_consts[31]);
    ...
    }
    {
        ...
        tmp_truediv_expr_left_4 = LOOKUP_ATTRIBUTE(tmp_expression_value_29, mod_consts[30]);
        ...
        tmp_truediv_expr_left_5 = LOOKUP_ATTRIBUTE(tmp_expression_value_31, mod_consts[31]);
...
static PyObject *impl_matplotlib$tight_bbox$$$function__1_adjust_bbox$$$function__3_restore_bbox(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_515906ff1c2eefb016498c34ceb21c96)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_515906ff1c2eefb016498c34ceb21c96 = MAKE_FUNCTION_FRAME(codeobj_515906ff1c2eefb016498c34ceb21c96, module_matplotlib$tight_bbox, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_515906ff1c2eefb016498c34ceb21c96);
...
static PyObject *impl_matplotlib$tight_bbox$$$function__2_process_figure_for_rasterizing(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_c87aad3536103b9085345724cc9081d3)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_c87aad3536103b9085345724cc9081d3 = MAKE_FUNCTION_FRAME(codeobj_c87aad3536103b9085345724cc9081d3, module_matplotlib$tight_bbox, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_c87aad3536103b9085345724cc9081d3);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_75060be17288af68b26c1e942a075da8);
