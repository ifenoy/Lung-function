...
static PyObject *impl_matplotlib$tri$tripcolor$$$function__1_tripcolor(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_c7a5a90fcbe5a241bf34af476ad539c8);
    ...
    branch_end_11:;
    {
...

        {
            ...
            tmp_assign_source_17 = impl___main__$$$function__1_complex_call_helper_pos_star_dict(dir_call_args);
        }
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_5)) {
            ...
            tmp_assign_source_10 = IMPORT_NAME_FROM_MODULE(tmp_import_name_from_5, mod_consts[4]);
        }
