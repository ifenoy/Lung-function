...
static PyObject *impl_matplotlib$tri$triplot$$$function__1_triplot(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_c48db982754712be26eb3d09d72bb0d5);
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_iter_arg_1 = impl___main__$$$function__6_complex_call_helper_star_list_star_dict(dir_call_args);
        }
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_33 = impl___main__$$$function__7__unpack_dict(dir_call_args);
        }
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_36 = impl___main__$$$function__1_complex_call_helper_pos_star_dict(dir_call_args);
        }
    ...
    branch_no_2:;
    {
        ...
        tmp_dircall_arg2_3 = DEEP_COPY_TUPLE_GUIDED(mod_consts[30], "ll");
        CHECK_OBJECT(var_kw_lines);
...

        {
            ...
            tmp_assign_source_37 = impl___main__$$$function__1_complex_call_helper_pos_star_dict(dir_call_args);
        }
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_39 = impl___main__$$$function__7__unpack_dict(dir_call_args);
        }
    ...
    branch_yes_3:;
    {
...

        {
            ...
            tmp_assign_source_40 = impl___main__$$$function__1_complex_call_helper_pos_star_dict(dir_call_args);
        }
    ...
    branch_no_3:;
    {
        ...
        tmp_dircall_arg2_5 = DEEP_COPY_TUPLE_GUIDED(mod_consts[30], "ll");
        CHECK_OBJECT(var_kw_markers);
...

        {
            ...
            tmp_assign_source_41 = impl___main__$$$function__1_complex_call_helper_pos_star_dict(dir_call_args);
        }
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_099be7d67f72030c93afacc60f280bcd);
