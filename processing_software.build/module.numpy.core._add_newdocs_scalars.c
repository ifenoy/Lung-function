...
static PyObject *impl_numpy$core$_add_newdocs_scalars$$$function__1_numeric_type_aliases(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_caeb15dc775b902fe3e0af73177735ad = MAKE_FUNCTION_FRAME(codeobj_caeb15dc775b902fe3e0af73177735ad, module_numpy$core$_add_newdocs_scalars, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_caeb15dc775b902fe3e0af73177735ad);
...
static PyObject *numpy$core$_add_newdocs_scalars$$$function__1_numeric_type_aliases$$$function__1_type_aliases_gen$$$genobj__1_type_aliases_gen_context(struct Nuitka_GeneratorObject *generator, PyObject *yield_return_value) {
    ...
    if (isFrameUnusable(cache_m_frame)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_m_frame = MAKE_FUNCTION_FRAME(codeobj_dde2a187fd94b7bae6ef55de08c3b3cb, module_numpy$core$_add_newdocs_scalars, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
...
static PyObject *impl_numpy$core$_add_newdocs_scalars$$$function__2_add_newdoc_for_scalar_type(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_14479b351cd2d098b0ecd168a38dae58)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_14479b351cd2d098b0ecd168a38dae58 = MAKE_FUNCTION_FRAME(codeobj_14479b351cd2d098b0ecd168a38dae58, module_numpy$core$_add_newdocs_scalars, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_14479b351cd2d098b0ecd168a38dae58);
...
static PyObject *numpy$core$_add_newdocs_scalars$$$function__2_add_newdoc_for_scalar_type$$$genexpr__1_genexpr_context(struct Nuitka_GeneratorObject *generator, PyObject *yield_return_value) {
    ...
    if (isFrameUnusable(cache_m_frame)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_m_frame = MAKE_FUNCTION_FRAME(codeobj_4917214531e0760d3918fedd06b2bc0f, module_numpy$core$_add_newdocs_scalars, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
...
static PyObject *numpy$core$_add_newdocs_scalars$$$function__2_add_newdoc_for_scalar_type$$$genexpr__2_genexpr_context(struct Nuitka_GeneratorObject *generator, PyObject *yield_return_value) {
    ...
    if (isFrameUnusable(cache_m_frame)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_m_frame = MAKE_FUNCTION_FRAME(codeobj_5483bd8fd6120a980d77b8d89a691a90, module_numpy$core$_add_newdocs_scalars, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        tmp_args_element_value_3 = MAKE_TUPLE_EMPTY(2);
        {
            ...
            frame_0357497fae0c9255e15cb454ed4c2377->m_frame.f_lineno = 262;
            {
                ...
                tmp_tuple_element_1 = CALL_FUNCTION_WITH_ARGS1_KWSPLIT(unicode_builtin_format, args, kw_values, mod_consts[106]);
            }
    ...
    }
    {
        ...
        tmp_args_element_value_9 = MAKE_TUPLE_EMPTY(2);
        {
            ...
            tmp_called_value_30 = LOOKUP_ATTRIBUTE(tmp_expression_value_1, mod_consts[117]);
            Py_DECREF(tmp_expression_value_1);
