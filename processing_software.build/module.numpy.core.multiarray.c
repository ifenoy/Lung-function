...
static PyObject *impl_numpy$core$multiarray$$$function__2_concatenate(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_f8ed4e808610e0990bba0a83728c6e90 = MAKE_FUNCTION_FRAME(codeobj_f8ed4e808610e0990bba0a83728c6e90, module_numpy$core$multiarray, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_f8ed4e808610e0990bba0a83728c6e90);
...
static PyObject *impl_numpy$core$multiarray$$$function__5_lexsort(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_1d3665c27262401733d85adc9585357f)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_1d3665c27262401733d85adc9585357f = MAKE_FUNCTION_FRAME(codeobj_1d3665c27262401733d85adc9585357f, module_numpy$core$multiarray, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_1d3665c27262401733d85adc9585357f);
