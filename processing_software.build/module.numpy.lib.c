...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_5)) {
            ...
            tmp_assign_source_10 = IMPORT_NAME_FROM_MODULE(tmp_import_name_from_5, mod_consts[51]);
        }
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_6)) {
            ...
            tmp_assign_source_26 = IMPORT_NAME_FROM_MODULE(tmp_import_name_from_6, mod_consts[56]);
        }
