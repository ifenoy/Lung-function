...
static PyObject *impl_numpy$polynomial$polynomial$$$function__24__str_term_ascii(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_afeb9e48a612e992b3427120b134f14e)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_afeb9e48a612e992b3427120b134f14e = MAKE_FUNCTION_FRAME(codeobj_afeb9e48a612e992b3427120b134f14e, module_numpy$polynomial$polynomial, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_afeb9e48a612e992b3427120b134f14e);
...
static PyObject *impl_numpy$polynomial$polynomial$$$function__25__repr_latex_term(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_1b5f38b90fff0dba69e652bba71e4af8)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_1b5f38b90fff0dba69e652bba71e4af8 = MAKE_FUNCTION_FRAME(codeobj_1b5f38b90fff0dba69e652bba71e4af8, module_numpy$polynomial$polynomial, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_1b5f38b90fff0dba69e652bba71e4af8);
